...
from boxmot_botsort.appearance.backbones.clip.make_model import make_model
from boxmot_botsort.appearance.backbones.hacnn import HACNN
from boxmot_botsort.appearance.backbones.lmbn.lmbn_n import LMBN_n
from boxmot_botsort.appearance.backbones.mlfn import mlfn
from boxmot_botsort.appearance.backbones.mobilenetv2 import mobilenetv2_x1_0, mobilenetv2_x1_4
from boxmot_botsort.appearance.backbones.osnet import (
    osnet_ibn_x1_0,
    osnet_x0_5,
    osnet_x0_25,
    osnet_x0_75,
...
from boxmot_botsort.appearance.backbones.osnet_ain import (
    osnet_ain_x0_5,
    osnet_ain_x0_25,
    osnet_ain_x0_75,
    osnet_ain_x1_0,
)
from boxmot_botsort.appearance.backbones.resnet import resnet50, resnet101
...
def build_model(name, num_classes, loss="softmax", pretrained=True, use_gpu=True):
    ...
    if 'clip' in name:
        ...
        from boxmot_botsort.appearance.backbones.clip.config.defaults import _C as cfg
